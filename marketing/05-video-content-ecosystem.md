...
## 1. Anchor explainer series: *VERIFIED*

**Format:** 3 episodes, 90–120 s each, presenter-led (our green buyer, on location) + motion-graphic data layer. Published on YouTube (home), cut down everywhere else (§3). Tone per brand voice (file 06 §7): specialty-literate, sensory, numbers before adjectives.
...
|---|---|---|---|
| 0:00–0:03 | **HOOK** | "This bag traveled 7,000 miles. Its story fits in eight data fields — and every one of them is checkable." | Jute bag slam-cut; origin stamp spins: **GEDEB → OAKLAND** |
| 0:03–0:18 | Origin & elevation | "Gedeb, southern Ethiopia. Two thousand one hundred meters. Altitude is not a vibe — it's temperature. Cooler nights, slower cherry ripening, denser seeds. Density is where the acids live." | Drone: ridge lines at dawn. GFX line-graph: temp ↓ → maturation days ↑ |
| 0:18–0:38 | Varietal & process | "Heirloom varietals, washed process: depulped within hours, fermented 36 to 48 hours, washed clean, dried slow on raised beds. Washed done right means the cup tastes like the place, not the process. Floral, apricot, black tea." | Macro: mucilage slick on parchment; beds turning. Super: **washed / 36–48 h / raised beds** |
| 0:38–0:58 | The score | "Then the cupping. SCA protocol: five bowls, eleven minutes, a Q-grader who has no idea what this coffee sells for. Eighty-six point five — fragrance eight-five, acidity eight-seven-five. That number survives because nobody who profits from it was in the room." | Scoresheet close-up; blind-cupping wide: numbered bowls, no labels |
| 0:58–1:18 | Logistics & honesty | "Harvest week, ship date, port, warehouse, bags remaining. Forty bags. Not 'limited time offer' — forty physical bags in Oakland, and the count drops in public when one sells." | Warehouse b-roll (see file 06 §5); live counter GFX: **40 → 39** |
| 1:18–1:40 | Why it matters | "When every field is verifiable, you stop buying stories and start buying coffee. You can compare a Gedeb to a Huila on facts. You can hold your importer — us — to account." | Split lot-cards: Gedeb vs Huila, field-by-field checkmarks |
| 1:40–1:50 | **CTA** | "Cup the Gedeb blind. The scoresheet's in the box. The kit's free." | End card: **Anatomy verified. Your turn →** URL + QR |
...
| Time | Beat | VO | On-screen text / GFX |
|---|---|---|---|
| 0:00–0:03 | **HOOK** | "Nine days ago, Maya had never heard of us. Today she's reordering." | Calendar page flip: **DAY 1 → DAY 9**; roastery door sign (hero roaster cameo, scripted) |
| 0:03–0:16 | Day 1–2: the kit | "Day one: she claims a free sample kit. Three lots matched to her roast profile. Day two, it ships — tracking, scoresheets, landed-cost math to the cent, in the box." | Kit assembly b-roll; packing list macro: **$6.85/lb landed** |
| 0:16–0:34 | Day 4: the cupping | "Day four: eleven minutes, five bowls. She scores the washed Gedeb blind — 86.25. The Q-grader's sheet says 86.5. Quarter point apart. That's not marketing alignment; that's measurement." | Stopwatch super: **11:00**; her scorecard vs reference: **86.25 / 86.5** |
| 0:34–0:52 | Day 5: the order | "Day five: the shortlist. Her scores tune it — she liked the acidity, so the model leans bright: a honey-process Pink Bourbon, a washed Kenya. She orders sixty pounds of the Gedeb. Split-bag. No contract. Price locked fourteen days." | UI: sliders → shortlist → checkout. Super: **60 lbs / split-bag / 14-day lock** |
| 0:52–1:08 | Day 9: the habit | "Day nine: delivery. The counter drops forty to thirty-nine, publicly. In eight weeks her par-level alert fires before her spreadsheet notices she's low. That's the whole product: proof up front, then the plumbing disappears." | Delivery b-roll; counter **40→39**; settings toggle: **auto-replenish ON** |
| 1:08–1:20 | Reflection | "Nobody sold Maya anything. She cupped, she checked, she bought. That's how specialty coffee is supposed to work — we just built the rails." | Maya back at the roaster; steam; quiet confidence |
| 1:20–1:30 | **CTA** | "Your day one is free. The scoresheet's already printed." | End card: **Start day one →** URL + QR |

---

## 2. Always-on content spine (feeds the cutdown matrix)

Beyond anchors, a weekly cadence of 15–45 s verticals from one quarterly shoot (b-roll bank, file 06 §5): **"Score Reveal"** (cup a lot, reveal the Q-score after the roaster's guess), **"Sixty-Second Origin"** (one origin, one fact that changes how you buy it), **"Warehouse Honesty"** (live bag counts, shipping mishaps and fixes — radical transparency content that makes the marketing claims credible). Each episode of *VERIFIED* must yield ≥ 9 cutdowns; spine content fills the gaps so no week ships without 3 new verticals.

---

## 3. Social cutdown matrix

Hook variants: **A = question** ("How much is a made-up cup score costing you?"), **B = bold stat** ("$9,000 a year. That's what believing an unverified 86.5 costs."), **C = pattern interrupt** (cold-open on the slurp/spit, no words for 2 s).

| Platform | Aspect | Length | Source | Hook variants | CTA end-card | Primary KPI |
|---|---|---|---|---|---|---|
| YouTube (anchor) | 16:9 | 90–120 s | Full episode | Native open (ep hook) | Verbal + end-screen → kit LP | VTR, watch time, subs |
| YouTube Shorts | 9:16 | 30–45 s | Ep proof beat (wager/score-match) | A, B, C | "Full film + free kit — link" | Swipe-away rate, CTR |
| LinkedIn organic | 1:1 | 45–60 s | Problem + turn beats; captions-first | A, B | Comment-bait line + link in comments | Completion, dwell, CTR |
| LinkedIn paid (supply-side) | 16:9 | 30 s | Ep3 workflow cut | B | "See lead scoring" → importer LP | SQL rate |
...
## 4. Thumbnail system (YouTube + link previews)
...
## 5. Sound-off subtitle & caption specs
...
- **Localization-ready:** English master SRT is the translation source; line-length budget ≤ 42 chars keeps ES/PT/JA expansions inside safe zones (hands off to the localization workstream).

---

## 6. Distribution calendar (launch quarter, 8-week cycle, then repeats with new anchors)

| Week | Anchor | Spine verticals (×3+) | Paid support | Notes |
|---|---|---|---|---|
| W1 | Ep1 premiere (YouTube + LinkedIn native) | 2× Score Reveal, 1× Warehouse Honesty | $2k YT in-feed to roaster-interest audiences | Premiere w/ live chat; founder in comments first 2 h |
| W2 | Ep1 cutdown wave (9 cutdowns all platforms) | 1× Sixty-Second Origin | LinkedIn sponsored (importer lookalikes) | Thumbnail test concludes W2 |
| W3 | Ep2 premiere | 2× Origin, 1× Score Reveal | $2k retargeting Ep1 viewers ≥ 50% | Chaptered SEO push ("what is washed process") |
...
### 7.1 Platform KPI targets

| Metric | YouTube 16:9 | Shorts/TikTok/Reels | LinkedIn |
|---|---|---|---|
| Hook hold (3 s → 10 s) | ≥ 70% | ≥ 65% (vs swipe) | ≥ 60% |
| VTR (complete or 30 s, whichever first) | ≥ 55% at 30 s | ≥ 25% full-completion | ≥ 35% at 30 s |
| Retention curve targets | ≥ 75% @ 15 s; ≥ 45% @ 60 s; ≥ 25% @ end (90 s) | ≥ 50% @ 50% mark | ≥ 40% @ 50% mark |
| CTR to LP | ≥ 1.2% (end-screen + desc) | ≥ 0.8% (bio/sticker) | ≥ 1.5% |
| Engaged-view conversion (kit claim ≤ 7 days) | ≥ 0.35% of ≥ 75% viewers | ≥ 0.15% | ≥ 0.5% |
| Cost guardrail (paid) | effective video-CAC ≤ $200/attributed signup | same | supply-side SQL ≤ $400 |

### 7.2 Retention-curve diagnostics (what shape tells us)

- **Cliff in first 5 s** → hook failure: re-cut hook variant, do not touch the body. (Cheap fix, do it weekly.)
- **Steady bleed 15–45 s** → pacing: tighten beats, add GFX change every ≤ 6 s.
- **Drop at product glimpse (~60–75%)** → the audience came for craft and smelled an ad: shorten UI segment, move CTA verbal earlier.
- **Flat but low CTR** → content beloved, offer invisible: strengthen end-card, pin comment with kit link.
...
Weekly 30-min content review: hook holds, curve shapes, CTR by variant → next week's re-cuts. Monthly: lift readouts, CAC guardrails, comment mining for topic pipeline. Quarterly: anchor shoot (b-roll bank refresh, file 06 §5), format retirement decisions (any format under target 2 consecutive months is killed or re-conceived — attention is rented, never owed).
